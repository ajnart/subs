...
export default function Component() {
  ...
  return (
    ...
    >
      <BorderBeam size={200} borderWidth={4} duration={15} colorFrom="#ffaa40" colorTo="#9c40ff" className="z-10" />
      ...
      <span className="text-sm text-gray-700 z-20">
        Made with <span className="font-bold text-purple-600">Kodu.ai</span>
      </span>
    </Link>
  )
}
