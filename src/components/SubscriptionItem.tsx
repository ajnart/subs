...
const SubscriptionItem: React.FC<SubscriptionItemProps> = ({ subscription, onRemove }) => {
  return (
    <div className="relative group">
      <Link href={subscription.url} target="_blank" rel="noopener noreferrer" className="block">
